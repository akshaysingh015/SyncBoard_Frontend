...
const handleGoToLogin = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#484c65] to-[#251233] px-4 font-tagesschrift">
      <div className="bg-gradient-to-br from-[#1d2732] to-[#0a0f17] rounded-2xl shadow-2xl w-full max-w-[1000px] flex overflow-hidden">
        {/* Left side - Form */}
        <div className="w-full md:w-1/2 p-10 relative flex flex-col justify-center">
          ...
          <div className="mb-5 text-center mt-10">
            <div className="flex gap-2 items-center justify-center">
              <h1 className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#c68bd4] to-[#8a45ad] mb-2">
                Welcome
              </h1>
            </div>
